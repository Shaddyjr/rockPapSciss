...
Entity.prototype.selfAssess = function(neighborEntity) {
  switch (neighborEntity.currentColor) {
    case "red":
      if (this.currentColor == "green") this.increaseLevel(neighborEntity.currentColor);
      break;
    case "blue":
      if (this.currentColor == "red") this.increaseLevel(neighborEntity.currentColor);
      break;
    case "green":
      if (this.currentColor == "blue") this.increaseLevel(neighborEntity.currentColor);
      break;
    default:
        if (this.currentColor != "white") neighborEntity.increaseLevel(this.currentColor);
      break;
  }
};
